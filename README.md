...
## Разработка web-приложения ["База данных резюме"](https://resumesbasedata.herokuapp.com/)

 Участие в проекте по созданию с нуля web-приложения, реализуя разные способы хранения резюме. Проект включает в себя следующее:
